...
-- Fix lazy-lock.json.json on read-only filesystem
-- vim.g.lazyvim_json = vim.fn.stdpath("state") .. "/lazy-lock.json",
vim.g.lazyvim_json = "/home/mogos/Documents/lazy-lock.json"
